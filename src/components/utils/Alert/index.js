...
const Alert = ({ show, message, variant, dummy = false }) => {
    const { showAlert } = useWeb()
    ...
    return (
        <div className={[
            'p-[16px] m-1 flex justify-start items-center gap-2 w-full max-w-[320px] text-contentl shadow-default rounded font-button cursor-pointer z-50',
            alertVariant,
